...
?>
                        ...
                        <div class="tshadow mb25 bozero">
                                <h3 class="pagetitleh2">Student Identification Systems</h3>
                                <div class="around10">
                                            <div class="col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">PEN <small>Permanent Education Number</small></label>
                                            
                                                    <input type="text" value="<?php echo $student["pen"] ?>" name="pen" class="form-control" value="<?php echo set_value('pen', $student['pen']); ?>">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">RFID <small>Radio Frequency Identification</small> </label>
                                            
                                                    <input type="text" value="<?php echo $student["rfid"] ?>" name="rfid" class="form-control" value="<?php echo set_value('rfid', $student['rfid']); ?>">
