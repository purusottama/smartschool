                ...
                <div class="box box-primary transparent_bg" <?php
                    ...
                    <div class="box box-widget widget-user-2 mb0">
                        <div class="widget-user-header bg-gray-light overflow-hidden">
                            ...
                            <h5 class="widget-user-desc mb5">PEN <span class="text-aqua"><?php echo $student['pen']; ?></span></h5>
                            <h5 class="widget-user-desc mb5">RFID <span class="text-aqua"><?php echo $student['rfid']; ?></span></h5>
