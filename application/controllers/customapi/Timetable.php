...
class Timetable extends My_Controller
{
    ...
    public function index()
    {
        ...
        return $this->output->set_output(json_encode([
                        'status' => false,
                        'success_message' => "class_id , section_id, group_id  sessionlist List",
                        'data' => $data
                    ]));
    ...
    public function mytimetable()
    {
        ...
        $staff_id          = $this->input->post('staff_id',true);//$this->customlib->getStaffID();
        ...
        return $this->output->set_output(json_encode([
                        'status' => true,
                        'success_message' => "My Time table List",
                        'data' => $data
                    ]));
